...
class VRP {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the vechicle capacity: ");
        int VehicleCap = input.nextInt();
        System.out.print("Enter the no of vechicles: ");
        ...
        for (int i = 1; i <= NoOfCustomers; i++) {
            System.out.print("Enter demand for customer " + i + ": ");
            int demand = input.nextInt();
            tot_dem=tot_dem+demand;
            Nodes[i] = new Node(i, // Id ) is reserved for depot
                    ran.nextInt(100), // Random Cordinates
                    ran.nextInt(100),
                    demand // User-input demand
            );
        }
        System.out.println("\ntotal demand by all customers : "+tot_dem);
        ...
        Thread t1 = new Thread("greedy");
        Thread t2 = new Thread("inter-route");
        Thread t3 = new Thread("intra-route");
        Thread t4 = new Thread("tabu");
...
class Vehicle extends Thread{
    ...
    public boolean CheckIfFits(int dem) // Check if we have Capacity Violati
    {
